    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj)
        {
            ...
            string response = HttpService.Post(xml, url, false, 6);//调用HTTP通信接口提交数据
        ...
        */
        public static WxPayData Refund(WxPayData inputObj)
        {
            ...
            string response = HttpService.Post(xml, url, true, 6);//调用HTTP通信接口提交数据到API
	    ...
	    */
	    public static WxPayData RefundQuery(WxPayData inputObj)
	    {
            ...
            string response = HttpService.Post(xml, url, false, 6);//调用HTTP通信接口以提交数据到API
	    ...
	    */
	    public static WxPayData Report(WxPayData inputObj)
	    {
            ...
            string response = HttpService.Post(xml, url, false, 1);
