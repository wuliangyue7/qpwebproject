            ...
            <div class="ui-pay-way">
              ...
              <form name="fmStep1" runat="server" id="fmStep1">
                <script type="text/javascript">
                    ...
                    function checkReAccounts() {
                        if ($.trim($("#txtPayReAccounts").val()) == "") {
                            $("#txtPayReAccountsTips").html("请再次输入充值帐号");
                            return false;
                        }
                ...
                <ul>
                  ...
                  <li>
                    <label>充值金额：</label>
                    <ul class="ui-pay-money">
                      <li>
                        <input type="radio" id="rbSaleType1" name="rbSaleType" runat="server" value="10" checked="true" />
                        <span>使用10元充值卡，获取 <%= rateCurrency * 10%> 游戏豆</span>
                      </li>
                      <li>
                        <input type="radio" id="rbSaleType2" name="rbSaleType" runat="server" value="20" />
                        <span>使用20元充值卡，获取 <%= rateCurrency * 20%> 游戏豆</span>
                      </li>
                      <li>
                        <input type="radio" id="rbSaleType3" name="rbSaleType" runat="server" value="30" />
                        <span>使用30元充值卡，获取 <%= rateCurrency * 30%> 游戏豆</span>
                      </li>
                      <li>
                        <input type="radio" id="rbSaleType4" name="rbSaleType" runat="server" value="50" />
                        <span>使用50元充值卡，获取 <%= rateCurrency * 50%> 游戏豆</span>
                      </li>
                      <li>
                        <input type="radio" id="rbSaleType5" name="rbSaleType" runat="server" value="100" />
                        <span>使用100元充值卡，获取 <%= rateCurrency * 100%> 游戏豆</span>
                      </li>
                    </ul>
                  </li>
                  <li>
