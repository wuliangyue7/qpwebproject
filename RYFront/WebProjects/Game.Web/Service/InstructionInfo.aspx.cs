...
{
    public partial class InstructionInfo : UCPageBase
    {
        public string title = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                GameIssueInfo issure1 = FacadeManage.aideNativeWebFacade.GetIssueByIssueID(4, IntParam, 1);
                if (issure1 != null)
                {
                    this.linLast.Title = "上一篇新闻：" + issure1.IssueTitle;
                    this.linLast.HRef = "/Service/InstructionInfo.aspx?param=" + issure1.IssueID;
                }
                else
                {
                ...
                GameIssueInfo issure2 = FacadeManage.aideNativeWebFacade.GetIssueByIssueID(4, IntParam, 2);
                if (issure2 != null)
                {
                    this.linNext.Title = "下一篇新闻：" + issure2.IssueTitle;
                    this.linNext.HRef = "/Service/InstructionInfo.aspx?param=" + issure2.IssueID;
                }
                else
                {
