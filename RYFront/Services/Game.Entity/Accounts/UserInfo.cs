...
namespace Game.Entity.Accounts
{
    ...
    public partial class UserInfo
    {
        ...
        private string m_dynamicPass;               //动态密码
        private DateTime m_dynamicPassTime;         //动态密码更新时间
        ...
        public UserInfo( int userID, string accounts, int gameID)
        {
            m_userID = userID;
            m_accounts = accounts;
            m_gameID = gameID;
        ...
        public UserInfo( UserTicketInfo userTicket )
            : this( userTicket.UserID, userTicket.Accounts, userTicket.GameID)
        {
        }
        ...
        {
            get { return m_dynamicPass; }
            set { m_dynamicPass = value; }
        }
        ...
        {
            get { return m_dynamicPassTime; }
            set { m_dynamicPassTime = value; }
        }
        ...
        {
            return new UserTicketInfo( suInfo.UserID, suInfo.GameID, suInfo.Accounts );
        }
