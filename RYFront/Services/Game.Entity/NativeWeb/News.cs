...
namespace Game.Entity.NativeWeb
{
	...
	public partial class News  
	{
		...
		private byte m_classID;						//新闻类别 (新闻 1; 公告 2;手机公告 3)
		private string m_gameRange;					//手机公告 显示范围
        private string m_imageUrl;                  //广告图片
		...
		{
			get { return m_gameRange; }
			set { m_gameRange = value; }
		}
