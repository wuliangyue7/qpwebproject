    ...
    public class PasswordCard
    {
        ...
        public void CreateSerialNumber()
        {
            ...
            while( j )
            {
                ...
                if( !FacadeManage.aideAccountsFacade.PasswordIDIsEnable( numberList ) )
                {
        ...
        {
            Image newImage = Image.FromFile( bgPath, false );
            Graphics g = Graphics.FromImage( newImage );
            Color color = System.Drawing.Color.FromArgb( 255, 224, 189 );
            Color colorBold = System.Drawing.Color.FromArgb( 112, 51, 0 );

            //渐变画刷
            //System.Drawing.Drawing2D.LinearGradientBrush brush = new System.Drawing.Drawing2D.LinearGradientBrush( new Rectangle( 0, 0, newImage.Width, newImage.Height ), color, color, 4.0f, true );
            Brush brush = new SolidBrush( color );
            Brush brushBold = new SolidBrush( colorBold );

            Font font = new System.Drawing.Font( "Arial", 10 );
            Font fontBold = new System.Drawing.Font( "Arial", 10, FontStyle.Bold );

            g.DrawString( AddSpace(), fontBold, brushBold, 65, 8, StringFormat.GenericTypographic );
