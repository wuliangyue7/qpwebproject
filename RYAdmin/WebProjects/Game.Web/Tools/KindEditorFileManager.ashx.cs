...
namespace Game.Web.Tools
{
    public class KindEditorFileManager : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest( HttpContext context )
        {
            ...
            {
                context.Response.Write( "管理员未登陆，不能上传图片。" );
                return;
            }
            ...
            ConfigInfo configInfo = FacadeManage.aideNativeWebFacade.GetConfigInfo( EnumerationList.SiteConfigKey.SiteConfig.ToString() );
            rootUrl = configInfo == null ? "" : configInfo.Field3 + "/";
