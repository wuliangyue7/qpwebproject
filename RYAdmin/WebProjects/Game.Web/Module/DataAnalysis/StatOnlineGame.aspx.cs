...
namespace Game.Web.Module.AppManager
{
    public partial class StatOnlineGame : AdminPage
    {
        ...
        private void DrawImage(string year, string month, string day, string hour)
        {
            ...
            //获取游戏列表
            DataSet dsGame = FacadeManage.aidePlatformFacade.GetGameKindItemList( 1, Int32.MaxValue, "", "ORDER BY KindID ASC" ).PageSet;
            DataSet ds = FacadeManage.aidePlatformFacade.GetOnlineStreamGameInfoList( year, month, day, hour );
