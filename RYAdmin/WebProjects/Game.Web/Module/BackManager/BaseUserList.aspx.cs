...
namespace Game.Web.Module.BackManager
{
    public partial class BaseUserList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aidePlatformManagerFacade.DeleteUser(StrCIdList);
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        protected void btnDongjie_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aidePlatformManagerFacade.ModifyUserNullity(StrCIdList, true);
                ShowInfo("冻结成功");
            }
            catch
            {
        ...
        protected void btnJiedong_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aidePlatformManagerFacade.ModifyUserNullity(StrCIdList, false);
                ShowInfo("解冻成功");
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformManagerFacade.GetUserList(anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);
