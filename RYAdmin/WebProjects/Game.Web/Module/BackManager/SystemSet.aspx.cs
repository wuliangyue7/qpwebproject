...
namespace Game.Web.Module.BackManager
{
    public partial class SystemSet : AdminPage
    {
        ...
        {
            QPAdminSiteInfo siteInfo = FacadeManage.aidePlatformManagerFacade.GetQPAdminSiteInfo( 1 );
            if ( siteInfo == null )
                return;
        ...
        private void ProcessData( )
        {
            ...
            try
            {
                FacadeManage.aidePlatformManagerFacade.UpdateQPAdminSiteInfo( siteInfo );
                ShowInfo( "操作成功" );
            }
            catch 
            {
