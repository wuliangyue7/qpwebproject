...
namespace Game.Web.Module.AppManager
{
    public partial class FinanceInfo : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetRecordSpreadInfoList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
            ...
            ds = FacadeManage.aideTreasureFacade.GetDataSetBySql( sqlQuery );
            if( ds.Tables[0].Rows.Count > 0 )
            {
                DataRow row = ds.Tables[0].Rows[0];
