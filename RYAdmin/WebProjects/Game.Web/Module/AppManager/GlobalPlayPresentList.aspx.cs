...
namespace Game.Web.Module.AppManager
{
    public partial class GlobalPlayPresentList : AdminPage
    {
        ...
        protected void btnDelete_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aidePlatformFacade.DeleteGlobalPlayPresent( strQuery );
                ShowInfo( "删除成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetGlobalPlayPresentList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
