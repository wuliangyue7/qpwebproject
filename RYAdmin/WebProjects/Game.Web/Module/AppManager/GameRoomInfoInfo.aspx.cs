...
namespace Game.Web.Module.AppManager
{
    public partial class GameRoomInfoInfo : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetGameNodeItemList( 1, Int32.MaxValue, "", "ORDER BY NodeID ASC" );
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetDataBaseList( 1, Int32.MaxValue, "", "ORDER BY DBInfoID ASC" );
            if (pagerSet.PageSet.Tables[0].Rows.Count > 0)
            {
