...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlPTypeID" runat="server" Width="156px">
                </asp:DropDownList>       
            </td>
        </tr>  
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlMTypeID" runat="server" Width="156px">
                </asp:DropDownList>       
            </td>
        </tr>  
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="chkSuportMobile" runat="server" Text="支持" />
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtSendLoveLiness" runat="server" CssClass="text" validate="{digits:true}"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
            ...
            <td>
                <asp:TextBox ID="txtRecvLoveLiness" runat="server" CssClass="text" validate="{digits:true}"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
