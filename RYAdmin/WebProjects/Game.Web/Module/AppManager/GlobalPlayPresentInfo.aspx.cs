...
namespace Game.Web.Module.AppManager
{
    public partial class GlobalPlayPresentInfo : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetGameRoomInfoList( 1, int.MaxValue, "", "ORDER BY ServerID ASC" );
            ...
            ddlGameRoom.Items.Insert( 1, new ListItem( "游戏币房间", "-1" ) );
        }
        ...
        private void BindData()
        {
            ...
            GlobalPlayPresent globalPlayPresent = FacadeManage.aidePlatformFacade.GetGlobalPlayPresentInfo( IntParam );
