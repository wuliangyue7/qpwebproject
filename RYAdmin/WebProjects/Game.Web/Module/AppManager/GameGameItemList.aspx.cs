...
namespace Game.Web.Module.AppManager
{
    public partial class GameGameItemList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = "WHERE GameID in (" + StrCIdList + ")";
            try
            {
                FacadeManage.aidePlatformFacade.DeleteGameGameItem( strQuery );
                ShowInfo( "删除成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetGameGameItemList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
