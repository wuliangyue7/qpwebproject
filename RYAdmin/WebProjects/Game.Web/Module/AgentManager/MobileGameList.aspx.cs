...
{
    public partial class MobileGameList : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideAccountsFacade.GetList(AccountsAgentGame.Tablename, 1, int.MaxValue, string.Format("WHERE AgentID={0} AND DeviceID=2", IntParam), "ORDER BY SortID ASC");
