...
{
    public partial class PcGameInfo : AdminPage
    {
        #region Fields
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetGameKindItemList(1, Int32.MaxValue, "WHERE Nullity=0", "ORDER BY KindID ASC");
