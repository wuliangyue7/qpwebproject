...
namespace Game.Web.Module.FilledManager
{
    public partial class GlobalLivcardList : AdminPage
    {
        ...
        protected void btnDelete_Click( object sender , EventArgs e )
        {
            ...
            string sqlQuery = "Delete " + GlobalLivcard.Tablename + " WHERE CardTypeID in (" + StrCIdList + ")";
            int resutl = FacadeManage.aideTreasureFacade.ExecuteSql( sqlQuery );
            if ( resutl > 0 )
            {
                ShowInfo( "删除成功" );
            }
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetGlobalLivcardList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
