...
namespace Game.Web.Module.FilledManager
{
    public partial class OrderVBList : AdminPage
    {
        ...
        protected void btnDelete_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideTreasureFacade.DeleteVBDetail( strQuery );
                ShowInfo( "删除成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetVBDetailList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
