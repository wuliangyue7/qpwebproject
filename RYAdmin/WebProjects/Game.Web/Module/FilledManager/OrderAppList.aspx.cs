...
{
    public partial class OrderAppList : AdminPage
    {
        #region 窗口事件
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetAppDetailList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
