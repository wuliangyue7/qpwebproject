...
namespace Game.Web.Module.MallManager
{
    public partial class MallInfoList : AdminPage
    {
        ...
        {
            //控件绑定
            PagerSet pagerSet = FacadeManage.aideNativeWebFacade.GetList( AwardInfo.Tablename, anpPage.CurrentPageIndex, anpPage.PageSize, GetWhere(), "ORDER BY SortID DESC" );
