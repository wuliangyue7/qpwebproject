...
namespace Game.Web.Module.WebManager
{
    public partial class RulesList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideNativeWebFacade.DeleteGameRules( strQuery );
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideNativeWebFacade.GetGameRulesList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
