...
namespace Game.Web.Module.WebManager
{
    public partial class MatchList : AdminPage
    {
        ...
        {
            //PagerSet pagerSet = FacadeManage.aideGameMatchFacade.GetList( Game.Entity.GameMatch.MatchInfo.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, Orderby, SearchItems );
