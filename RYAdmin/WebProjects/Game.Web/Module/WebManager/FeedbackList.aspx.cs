...
namespace Game.Web.Module.WebManager
{
    public partial class FeedbackList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = "WHERE FeedbackID in (" + StrCIdList + ")";
            try
            {
                FacadeManage.aideNativeWebFacade.DeleteGameFeedback( strQuery );
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        protected void btnDisable_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideNativeWebFacade.SetFeedbackDisbale( strQuery );
                ShowInfo( "冻结成功" );
            }
            catch
            {
        ...
        protected void btnEnable_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideNativeWebFacade.SetFeedbackEnbale( strQuery );
                ShowInfo( "解冻成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideNativeWebFacade.GetGameFeedbackList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
        ...
        public string Orderby
        {
            get
            {
                ...
                {
                    ViewState["Orderby"] = "ORDER BY IsProcessed ASC,FeedbackDate DESC";
                }
