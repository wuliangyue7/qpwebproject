...
namespace Game.Web.Module.WebManager
{
    public partial class NoticeList : AdminPage
    {
        ...
        protected void btnDelete_Click( object sender, EventArgs e )
        {
            ...
            string strQuery = "WHERE NoticeID in (" + StrCIdList + ")";
            try
            {
                FacadeManage.aideNativeWebFacade.DeleteNotice( strQuery );
                ShowInfo( "删除成功" );
            }
            catch
            {
        ...
        protected void btnDisable_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideNativeWebFacade.SetNoticeDisbale( strQuery );
                ShowInfo( "冻结成功" );
            }
            catch
            {
        ...
        protected void btnEnable_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideNativeWebFacade.SetNoticeEnbale( strQuery );
                ShowInfo( "解冻成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideNativeWebFacade.GetNoticeList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
