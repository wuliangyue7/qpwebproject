...
{
    public partial class AdsGameList : AdminPage
    {
        #region 窗口事件
        ...
        {
            //控件绑定
            PagerSet pagerSet = FacadeManage.aideNativeWebFacade.GetList("Ads", 1, 1000, " WHERE Type=1 OR Type=2", "ORDER BY ID ASC");
