    ...
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBoxList ID="cblUserType" runat="server" RepeatDirection="Horizontal" 
                        AutoPostBack="true" onselectedindexchanged="cblUserType_SelectedIndexChanged">
                        <asp:ListItem Text="普通玩家" Value="1" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="会员玩家" Value="2" Selected="True"></asp:ListItem>
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                   <asp:TextBox ID="txtStandardAwardGold" runat="server" CssClass="text wd7"></asp:TextBox>
                    &nbsp;<span class="hong">*</span>
            ...
            <tr>
                ...
                <td>
                   <asp:TextBox ID="txtStandardAwardMedal" runat="server" CssClass="text wd7"></asp:TextBox>
                    &nbsp;<span class="hong">*</span>
            ...
            <tr runat="server" id="trMemberGold">
                <td class="listTdLeft">会员玩家奖励金币：</td>
                <td>
                   <asp:TextBox ID="txtMemberAwardGold" runat="server" CssClass="text wd7"></asp:TextBox>
                    &nbsp;<span class="hong">*</span>
            ...
            <tr runat="server" id="trMemberMedal">
                <td class="listTdLeft">会员玩家奖励元宝：</td>
                <td>
                   <asp:TextBox ID="txtMemberAwardMedal" runat="server" CssClass="text wd7"></asp:TextBox>
                    &nbsp;<span class="hong">*</span>
