...
{
    public partial class RecordGrantMemberList : AdminPage
    {
        #region Fields       
        ...
        private void BindData( )
        {
            ...
            StrTitle = "玩家-" + account.Accounts + "-赠送会员记录";

            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantMemberList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
