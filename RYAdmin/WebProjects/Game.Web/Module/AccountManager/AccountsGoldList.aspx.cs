...
namespace Game.Web.Module.AccountManager
{
    public partial class AccountsGoldList : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetGameScoreInfoList( anpPage.CurrentPageIndex, anpPage.PageSize, SearchItems, Orderby );
        ...
        protected string GetRoomNameByUserID( int UserID )
        {
            ...
            string ServerID = FacadeManage.aideTreasureFacade.GetScalarBySql( sqlQuery.ToString() );
        ...
        protected string GetGameNameByUserID( int UserID )
        {
            ...
            string KindID = FacadeManage.aideTreasureFacade.GetScalarBySql( sqlQuery.ToString() );
