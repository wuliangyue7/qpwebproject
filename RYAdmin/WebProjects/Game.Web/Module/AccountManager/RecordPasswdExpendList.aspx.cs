...
{
    public partial class RecordPasswdExpendList : AdminPage
    {
        #region Fields
        ...
        private void BindData( )
        {
            ...
            StrTitle = "玩家-" + account.Accounts + "-修改密码记录";

            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordPasswdExpendList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
