...
{
    public partial class RecordGrantExperienceList : AdminPage
    {
        #region Fields      
        ...
        private void BindData( )
        {
            ...
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantExperienceList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
