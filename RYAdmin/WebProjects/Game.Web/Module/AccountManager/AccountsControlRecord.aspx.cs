...
{
    public partial class AccountsControlRecord : AdminPage
    {
        ...
        protected void BindData()
        {
            ...
            // 查询并绑定数据
            PagerSet pagerSet = FacadeManage.aideAccountsFacade.GetList("AccountsControlRecord", PageIndex, anpPage.PageSize, wheres.ToString(), "ORDER BY ConcludeDateTime DESC");
