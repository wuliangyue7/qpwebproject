...
{
    public partial class RecordGrantScoreList : AdminPage
    {
        #region Fields      
        ...
        private void BindData( )
        {
            ...
            StrTitle = "玩家-" + account.Accounts + "-赠送积分记录";

            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantGameScoreList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
