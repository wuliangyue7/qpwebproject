...
namespace Game.Web.Module.AccountManager
{
    public partial class GameScoreLockerList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideTreasureFacade.DeleteGameScoreLocker(strQuery);
                ShowInfo("删除成功");
                BindData();
            }
            catch
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetGameScoreLockerList(anpPage.CurrentPageIndex, anpPage.PageSize, SearchItems, Orderby);
