...
{
    public partial class RecordGrantGameIDList : AdminPage
    {
        #region Fields       
        ...
        private void BindData( )
        {
            ...
            StrTitle = "玩家-" + account.Accounts + "-赠送靓号记录";

            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantGameIDList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
