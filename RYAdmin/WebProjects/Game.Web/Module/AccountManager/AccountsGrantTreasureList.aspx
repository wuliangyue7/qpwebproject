            ...
            <asp:Repeater ID="rptDataList" runat="server">
                ...
                <AlternatingItemTemplate>
                    <tr align="center" class="listBg" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# (Convert.ToDouble(Eval("CurGold").ToString()) + Convert.ToDouble(Eval("AddGold").ToString())) < 0 ? "0" : (Convert.ToDouble(Eval("CurGold").ToString()) + Convert.ToDouble(Eval("AddGold").ToString())).ToString("NO")%>
                        </td>
                        <td title=" <%# Eval( "ClientIP" ).ToString( )%>">
                            <%# GetAddressWithIP( Eval( "ClientIP" ).ToString( ) )%>
                        </td>
