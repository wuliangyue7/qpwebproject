...
namespace Game.Web.Module.AccountManager
{
    public partial class AccountsList : AdminPage
    {
        ...
        protected void btnHightQuery_Click( object sender , EventArgs e )
        {
            ...
            if( ckbIsUser.Checked )
                where.Append( " AND IsAndroid=0" );
            if( ckbIsManager.Checked )
                where.Append( " AND MasterOrder>0" );
        ...
        protected void btnDongjie_Click( object sender , EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideAccountsFacade.DongjieAccount( strQuery );
                ShowInfo( "冻结成功" );
            }
            catch
            {
        ...
        protected void btnJiedong_Click( object sender , EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideAccountsFacade.JieDongAccount( strQuery );
                ShowInfo( "解冻成功" );
            }
            catch
            {
        ...
        protected void btnSetting_Click( object sender , EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideAccountsFacade.SettingAndroid( strQuery );
                ShowInfo( "设置成功" );
            }
            catch
            {
        ...
        protected void btnCancle_Click( object sender , EventArgs e )
        {
            ...
            try
            {
                FacadeManage.aideAccountsFacade.CancleAndroid( strQuery );
                ShowInfo( "操作成功" );
            }
            catch
            {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideAccountsFacade.GetAccountsList( anpPage.CurrentPageIndex, anpPage.PageSize, SearchItems, Orderby );
