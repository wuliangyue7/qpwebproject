...
{
    public partial class RecordGrantClearScoreList : AdminPage
    {
        #region Fields      
        ...
        private void BindData( )
        {
            ...
            StrTitle = "玩家-" + account.Accounts + "-清零积分记录";

            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantClearScoreList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
