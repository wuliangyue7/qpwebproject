...
namespace Game.Web.Module.AccountManager
{
    ...
    {       
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            {
                ConfineMachine model = FacadeManage.aideAccountsFacade.GetConfineMachineBySerial( strString );
                if ( model != null )
                {
                ...
                msg = FacadeManage.aideAccountsFacade.InsertConfineMachine( machine );
            }
            else
            {
                //判断权限
                ...
                msg = FacadeManage.aideAccountsFacade.UpdateConfineMachine( machine );
            }
