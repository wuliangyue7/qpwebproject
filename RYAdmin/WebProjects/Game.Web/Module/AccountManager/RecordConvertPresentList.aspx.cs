...
{
    public partial class RecordConvertPresentList : AdminPage
    {
        #region Fields
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordConvertPresentList( PageIndex, anpNews.PageSize, SearchItems, Orderby );
        ...
        public string SearchItems
        {
            get
            {
                if ( ViewState["SearchItems"] == null )
                {
                    ...
                    condition.Append( " WHERE UserID= " + IntParam );
