...
namespace Game.Web.Module.AccountManager
{
    public partial class AndroidList : AdminPage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideTreasureFacade.DeleteAndroid( strQuery );
                ShowInfo("删除成功");
            }
            catch
            {
        ...
        protected void btnDongjie_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideTreasureFacade.NullityAndroid( 1, strQuery );
                ShowInfo("冻结成功");
            }
            catch
            {
        ...
        protected void btnJiedong_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideTreasureFacade.NullityAndroid( 0, strQuery );
                ShowInfo("解冻成功");
            }
            catch
            {
        ...
        protected void btnQueryAcc_Click(object sender, EventArgs e)
        {
            ...
            if ( !string.IsNullOrEmpty( queryContent ) )
            {
                ...
                {
                    case 1:
                        condition.AppendFormat( " AND UserID={0}", GetUserIDByAccount( queryContent ) );
                        break;
                    case 2:
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetAndroidList( anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby );
            if (pagerSet.PageSet.Tables[0].Rows.Count > 0)
            {
