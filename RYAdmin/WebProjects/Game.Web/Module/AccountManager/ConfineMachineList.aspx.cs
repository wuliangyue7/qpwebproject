...
namespace Game.Web.Module.AccountManager
{
    public partial class ConfineMachineList : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                if(!string.IsNullOrEmpty(StrParam) && StrCmd.Equals("del"))
                {
                    ...
                    FacadeManage.aideAccountsFacade.DeleteConfineMachineBySerial(StrParam);
                    ShowInfo("删除成功");
                }
                BindData();
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FacadeManage.aideAccountsFacade.DeleteConfineMachine(strQuery);
        ...
        {
            PagerSet pagerSet = FacadeManage.aideAccountsFacade.GetConfineMachineList(PageIndex, anpNews.PageSize, SearchItems, Orderby);
