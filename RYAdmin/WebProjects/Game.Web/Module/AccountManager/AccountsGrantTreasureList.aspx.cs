...
{
    public partial class AccountsGrantTreasureList : AdminPage
    {
        #region 窗口事件
        ...
        {
            Response.Redirect("AccountsGrantTreasureList.aspx");
        }
        #endregion
        ...
        {
            PagerSet pagerSet = FacadeManage.aideRecordFacade.GetRecordGrantTreasureList(PageIndex, anpNews.PageSize, SearchItems, Orderby);
