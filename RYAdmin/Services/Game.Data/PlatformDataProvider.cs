...
namespace Game.Data
{
    ...
    public class PlatformDataProvider : BaseDataProvider, IPlatformDataProvider
    {
            ...
            : base( connString )
        {
            ...
            aideGameConfigProvider = GetTableProvider( GameConfig.Tablename );
            aideTaskInfoProvider = GetTableProvider( TaskInfo.Tablename );
            aideGamePropertyProvider = GetTableProvider(GameProperty.Tablename);
            aideGamePropertySubProvider = GetTableProvider(GamePropertySub.Tablename);
            aideGamePropertyTypeProvider = GetTableProvider(GamePropertyType.Tablename);
            aideMobileKindItemProvider = GetTableProvider(MobileKindItem.Tablename);
        }
        #endregion
        ...
        public void InsertGameGameItem( GameGameItem gameGameItem )
        {
            ...
            dr[GameGameItem._SuportType] = gameGameItem.SuportType;
        ...
        public void InsertGameKindItem( GameKindItem gameKindItem )
        {
            ...
            dr[GameKindItem._Recommend] = gameKindItem.Recommend;
            dr[GameKindItem._GameFlag] = gameKindItem.GameFlag;
        ...
        public void UpdateGameKindItem( GameKindItem gameKindItem )
        {
            ...
            prams.Add(Database.MakeInParam("Recommend", gameKindItem.Recommend));
            prams.Add(Database.MakeInParam("GameFlag", gameKindItem.GameFlag));
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.AppendFormat( "UPDATE GameConfig SET NoticeChangeGolds={0},WinExperience={2} WHERE KindID={1}", gameConfig.NoticeChangeGolds, gameConfig.KindID, gameConfig.WinExperience );
            sqlQuery.AppendFormat( "IF @@ROWCOUNT=0 BEGIN " );
            sqlQuery.AppendFormat( "INSERT GameConfig(KindID,NoticeChangeGolds,WinExperience) VALUES({0},{1},{2}) ", gameConfig.KindID, gameConfig.NoticeChangeGolds, gameConfig.WinExperience );
            sqlQuery.Append( "END " );
            Database.ExecuteNonQuery( sqlQuery.ToString() );
        }
        ...
        {
            string sqlQuery = string.Format( "(NOLOCK) WHERE KindID={0}", kindID );
            GameConfig gameConfig = aideGameConfigProvider.GetObject<GameConfig>( sqlQuery );
            return gameConfig;
        }
        #endregion
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(MobileKindItem.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            string sqlQuery = string.Format("(NOLOCK) WHERE KindID= {0}", kindID);
            MobileKindItem gameKindItem = aideMobileKindItemProvider.GetObject<MobileKindItem>(sqlQuery);
            return gameKindItem;
        }
        ...
        {
            string sqlQuery = "SELECT MAX(KindID) FROM MobileKindItem(NOLOCK)";
            object obj = Database.ExecuteScalar(CommandType.Text, sqlQuery);
            if (obj == null || obj.ToString().Length <= 0)
                return 0;
            return int.Parse(obj.ToString());
        ...
        {
            DataRow dr = aideMobileKindItemProvider.NewRow();

            dr[MobileKindItem._KindID] = model.KindID;
            dr[MobileKindItem._KindName] = model.KindName;
            dr[MobileKindItem._TypeID] = model.TypeID;
            dr[MobileKindItem._ModuleName] = model.ModuleName;
            dr[MobileKindItem._ClientVersion] = model.ClientVersion;
            dr[MobileKindItem._ResVersion] = model.ResVersion;
            dr[MobileKindItem._SortID] = model.SortID;
            dr[MobileKindItem._KindMark] = model.KindMark;
            dr[MobileKindItem._Nullity] = model.Nullity;

            aideMobileKindItemProvider.Insert(dr);
        }
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("UPDATE MobileKindItem SET ")
                    .Append("KindName=@KindName, ")
            ...
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("KindName", model.KindName));
            prams.Add(Database.MakeInParam("ModuleName", model.ModuleName));
            prams.Add(Database.MakeInParam("ClientVersion", model.ClientVersion));
            prams.Add(Database.MakeInParam("ResVersion", model.ResVersion));
            prams.Add(Database.MakeInParam("SortID", model.SortID));
            prams.Add(Database.MakeInParam("KindMark", model.KindMark));
            prams.Add(Database.MakeInParam("Nullity", model.Nullity));
            prams.Add(Database.MakeInParam("KindID", model.KindID));
        ...
        {
            string sqlQuery = string.Format( " WHERE TaskID={0}", id );
            TaskInfo taskInfo = aideTaskInfoProvider.GetObject<TaskInfo>( sqlQuery );
            return taskInfo;
        }
        ...
        {
            DataRow dr = aideTaskInfoProvider.NewRow();
            dr[TaskInfo._TaskName] = info.TaskName;
            dr[TaskInfo._TaskType] = info.TaskType;
            dr[TaskInfo._UserType] = info.UserType;
            dr[TaskInfo._KindID] = info.KindID;
            dr[TaskInfo._StandardAwardGold] = info.StandardAwardGold;
            dr[TaskInfo._StandardAwardMedal] = info.StandardAwardMedal;
            dr[TaskInfo._MemberAwardGold] = info.MemberAwardGold;
            dr[TaskInfo._MemberAwardMedal] = info.MemberAwardMedal;
            dr[TaskInfo._TimeLimit] = info.TimeLimit;
            dr[TaskInfo._TaskDescription] = info.TaskDescription;
            dr[TaskInfo._InputDate] = info.InputDate;
            dr[TaskInfo._MatchID] = info.MatchID;
            dr[TaskInfo._Innings] = info.Innings;
            aideTaskInfoProvider.Insert( dr );
        }
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append( "UPDATE TaskInfo SET " )
            ...
            var prams = new List<DbParameter>();
            prams.Add( Database.MakeInParam( "TaskName", info.TaskName ) );
            prams.Add( Database.MakeInParam( "TaskType", info.TaskType ) );
            prams.Add( Database.MakeInParam( "UserType", info.UserType ) );
            prams.Add( Database.MakeInParam( "KindID", info.KindID ) );
            prams.Add( Database.MakeInParam( "StandardAwardGold", info.StandardAwardGold ) );
            prams.Add( Database.MakeInParam( "StandardAwardMedal", info.StandardAwardMedal ) );
            prams.Add( Database.MakeInParam( "MemberAwardGold", info.MemberAwardGold ) );
            prams.Add( Database.MakeInParam( "MemberAwardMedal", info.MemberAwardMedal ) );
            prams.Add( Database.MakeInParam( "TimeLimit", info.TimeLimit ) );
            prams.Add( Database.MakeInParam( "TaskDescription", info.TaskDescription ) );
            prams.Add( Database.MakeInParam( "MatchID", info.MatchID ) );
            prams.Add( Database.MakeInParam( "Innings", info.Innings ) );
            prams.Add( Database.MakeInParam( "TaskID", info.TaskID ) );
        ...
        {
            string sqlQuery = string.Format( "SELECT * FROM SigninConfig ORDER BY DayID ASC" );
            DataSet ds = Database.ExecuteDataset( sqlQuery );
            return ds;
        }
        ...
        public void UpdateSigninConfig( DataSet ds )
        {
            ...
            {
                sqlQuery.AppendFormat( "UPDATE SigninConfig SET RewardGold={0} WHERE DayID={1} ", dr[1], dr[0] );
                sqlQuery.AppendFormat( "IF @@ROWCOUNT=0 BEGIN " );
                sqlQuery.AppendFormat( "INSERT SigninConfig(DayID,RewardGold) VALUES({0},{1}) ", dr[0], dr[1] );
                sqlQuery.Append( "END " );
            }
            Database.ExecuteNonQuery( sqlQuery.ToString() );
        }
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append( "UPDATE GrowLevelConfig SET " )
                    .Append( "Experience=@Experience," )
                    .Append( "RewardGold=@RewardGold," )
                    .Append( "RewardMedal=@RewardMedal," )
                    .Append( "LevelRemark=@LevelRemark " )
                    .Append( "WHERE LevelID=@LevelID" );

            var prams = new List<DbParameter>();
            prams.Add( Database.MakeInParam( "Experience", glc.Experience ) );
            prams.Add( Database.MakeInParam( "RewardGold", glc.RewardGold ) );
            prams.Add( Database.MakeInParam( "RewardMedal", glc.RewardMedal ) );
            prams.Add( Database.MakeInParam( "LevelRemark", glc.LevelRemark ) );
            prams.Add( Database.MakeInParam( "LevelID", glc.LevelID ) );
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(GamePropertyType.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            string sqlQuery = string.Format("(NOLOCK) WHERE TypeID= {0}", typeID);
            GamePropertyType gamePropertyType = aideGamePropertyTypeProvider.GetObject<GamePropertyType>(sqlQuery);
            return gamePropertyType;
        }
        /// <summary>
        /// 获取道具类型ID的最大值
        /// </summary>
        ...
        {
            string sqlQuery = "SELECT MAX(TypeID) FROM GamePropertyType(NOLOCK)";
            object obj = Database.ExecuteScalar(CommandType.Text, sqlQuery);
            if (obj == null || obj.ToString().Length <= 0)
                return 0;
            return int.Parse(obj.ToString());
        ...
        {
            DataRow dr = aideGamePropertyTypeProvider.NewRow();

            dr[GamePropertyType._TypeID] = gamePropertyType.TypeID;
            dr[GamePropertyType._SortID] = gamePropertyType.SortID;
            dr[GamePropertyType._TypeName] = gamePropertyType.TypeName;
            dr[GamePropertyType._TagID] = gamePropertyType.TagID;
            dr[GameTypeItem._Nullity] = gamePropertyType.Nullity;

            aideGamePropertyTypeProvider.Insert(dr);
        }
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("UPDATE GamePropertyType SET ")
                    .Append("SortID=@SortID, ")
                    .Append("TypeName=@TypeName, ")
                    .Append("TagID=@TagID, ")
                    .Append("Nullity=@Nullity ")
            ...
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("TypeID", gamePropertyType.TypeID));
            prams.Add(Database.MakeInParam("SortID", gamePropertyType.SortID));
            prams.Add(Database.MakeInParam("TypeName", gamePropertyType.TypeName));
            prams.Add(Database.MakeInParam("TagID", gamePropertyType.TagID));
            prams.Add(Database.MakeInParam("Nullity", gamePropertyType.Nullity));
        ...
        {
            string sqlQuery = string.Format("SELECT * FROM GameProperty(NOLOCK) WHERE Kind= {0}", kind);
            return Database.ExecuteObjectList<GameProperty>(sqlQuery);
        }
        ...
        {
            string sqlQuery = string.Format("SELECT MAX(ID) FROM GameProperty(NOLOCK)");
            return Utils.Utility.StrToInt(Database.ExecuteScalar(CommandType.Text, sqlQuery), 0);
        }
        ...
        {
            DataRow dr = aideGamePropertyProvider.NewRow();

            dr[GameProperty._ID] = property.ID;
            dr[GameProperty._Name] = property.Name;
            dr[GameProperty._Kind] = property.Kind;
            dr[GameProperty._PTypeID] = property.PTypeID;
            dr[GameProperty._MTypeID] = property.MTypeID;
            dr[GameProperty._Cash] = property.Cash;
            dr[GameProperty._Gold] = property.Gold;
            dr[GameProperty._UserMedal] = property.UserMedal;
            dr[GameProperty._LoveLiness] = property.LoveLiness;
            dr[GameProperty._UseArea] = property.UseArea;
            dr[GameProperty._ServiceArea] = property.ServiceArea;
            dr[GameProperty._SuportMobile] = property.SuportMobile;
            dr[GameProperty._RegulationsInfo] = property.RegulationsInfo;
            dr[GameProperty._SendLoveLiness] = property.SendLoveLiness;
            dr[GameProperty._RecvLoveLiness] = property.RecvLoveLiness;
            dr[GameProperty._UseResultsGold] = property.UseResultsGold;
            dr[GameProperty._UseResultsValidTime] = property.UseResultsValidTime;
            dr[GameProperty._UseResultsValidTimeScoreMultiple] = property.UseResultsValidTimeScoreMultiple;
            dr[GameProperty._UseResultsGiftPackage] = property.UseResultsGiftPackage;
            dr[GameProperty._Recommend] = property.Recommend;
            dr[GameProperty._Nullity] = property.Nullity;

            aideGamePropertyProvider.Insert(dr);
        }
        ...
        public void UpdateGameProperty(GameProperty property)
        {
            ...
            prams.Add(Database.MakeInParam("Kind", property.Kind));
            prams.Add(Database.MakeInParam("PTypeID", property.PTypeID));
            prams.Add(Database.MakeInParam("MTypeID", property.MTypeID));
            prams.Add(Database.MakeInParam("Cash", property.Cash));
            prams.Add(Database.MakeInParam("Gold", property.Gold));
            prams.Add(Database.MakeInParam("UserMedal", property.UserMedal));
            prams.Add(Database.MakeInParam("LoveLiness", property.LoveLiness));
            prams.Add(Database.MakeInParam("UseArea", property.UseArea));
            prams.Add(Database.MakeInParam("ServiceArea", property.ServiceArea));
            prams.Add(Database.MakeInParam("SuportMobile", property.SuportMobile));
            ...
            prams.Add(Database.MakeInParam("UseResultsGold", property.UseResultsGold));
            prams.Add(Database.MakeInParam("UseResultsValidTime", property.UseResultsValidTime));
            prams.Add(Database.MakeInParam("UseResultsValidTimeScoreMultiple", property.UseResultsValidTimeScoreMultiple));
            prams.Add(Database.MakeInParam("UseResultsGiftPackage", property.UseResultsGiftPackage));
            prams.Add(Database.MakeInParam("Recommend", property.Recommend));
        ...
        {
            string sqlQueryAll = string.Format("UPDATE GameProperty SET Recommend={0} {1}", recommend, sqlQuery);
            Database.ExecuteNonQuery(sqlQueryAll);
        }
        #endregion
        ...
        {
            string sqlQuery = string.Format("(NOLOCK) WHERE ID= {0} AND OwnerID={1}", id, ownerID);
            GamePropertySub property = aideGamePropertySubProvider.GetObject<GamePropertySub>(sqlQuery);
            return property;
        }
        ...
        {
            DataRow dr = aideGamePropertySubProvider.NewRow();

            dr[GamePropertySub._ID] = property.ID;
            dr[GamePropertySub._OwnerID] = property.OwnerID;
            dr[GamePropertySub._Count] = property.Count;
            dr[GamePropertySub._SortID] = property.SortID;

            aideGamePropertySubProvider.Insert(dr);
        }
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("UPDATE GamePropertySub SET ")
                    .Append("Count=@Count ,")
                    .Append("SortID=@SortID ")
                    .Append("WHERE ID= @ID AND OwnerID=@OwnerID");
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("ID", property.ID));
            prams.Add(Database.MakeInParam("OwnerID", property.OwnerID));
            prams.Add(Database.MakeInParam("Count", property.Count));
            prams.Add(Database.MakeInParam("SortID", property.SortID));
        ...
        public Message AppStatOnline(string accounts, string logonPass, string machineID)
        {
            ...
            Message msg = MessageHelper.GetMessageForDataSet(Database, "APP_PM_StatOnline", prams);
            return msg;
        }
        ...
        public Message AppPlatformGeneral(string accounts, string logonPass, string machineID)
        {
            ...
            Message msg = MessageHelper.GetMessageForDataSet(Database, "APP_PM_PlatformGeneral", prams);
            return msg;
        }
        ...
        public Message AppStatUserOnline(string accounts, string logonPass, string machineID)
        {
            ...
            Message msg = MessageHelper.GetMessageForDataSet(Database, "APP_PM_StatUserOnline", prams);
            return msg;
        }
        ...
        public Message AppGetOnlineData(string accounts, string logonPass, string machineID, int dateType, string startDate, string endDate)
        {
            ...
            Message msg = MessageHelper.GetMessageForDataSet(Database, "APP_PM_GetOnlineData", prams);
            return msg;
        }
        #endregion
