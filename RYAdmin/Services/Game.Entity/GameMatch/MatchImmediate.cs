...
namespace Game.Entity.GameMatch
{
	...
	public partial class MatchImmediate  
	{
		...
		private int m_initialBase;				//初始基数(即初始游戏底分)
		private int m_initialScore;				//初始比赛分(为0时 表示使用当前金币为比赛分)
		...
		{
			get { return m_initialBase; }
			set { m_initialBase = value; }
		}
		...
		{
			get { return m_initialScore; }
			set { m_initialScore = value; }
		}
